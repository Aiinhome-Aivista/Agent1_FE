      ...
      <div className="p-6 space-y-6">
          ...
          return (
            analysis.root_cause && (
              <div>
                ...
                <div className="text-sm text-app-secondary whitespace-pre-wrap bg-app-bg p-4 rounded-lg border border-app-border leading-relaxed">
                  {analysis.root_cause}
                </div>
              </div>
            )
        ...
        {analysis.suggested_fix && (
          <div>
            ...
            <div className="text-sm text-app-primary whitespace-pre-wrap leading-relaxed italic border-l-4 border-app-brand pl-4 py-2">
              {analysis.suggested_fix}
            </div>
          </div>
        )}
